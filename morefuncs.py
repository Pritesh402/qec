...
def make_SI_circuit(b, d, p, ro, x, z, directory):
    # Save to ZY/y or ZY/z directory, and use b=y or b=z in filename
    newpath = f"{directory}/ZY/{b}/d={d},p={p},noise=ZY,b={b},r=3d,ro={ro},o={x[0]}{x[1]}{x[2]}{x[3]}{z[0]}{z[1]}{z[2]}{z[3]},idl=y.stim"  # MUST MATCH NEWPATH IN ADD_IDLING_ERRORS_AND_SAVE_CIRCUIT
